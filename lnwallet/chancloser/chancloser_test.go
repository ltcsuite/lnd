...
func (m *mockChannel) CreateCloseProposal(fee ltcutil.Amount,
	localScript, remoteScript []byte, _ ...lnwallet.ChanCloseOpt,
) (input.Signature, *chainhash.Hash, ltcutil.Amount, error) {
...
func (m *mockChannel) CompleteCooperativeClose(localSig,
	...
	proposedFee ltcutil.Amount,
	_ ...lnwallet.ChanCloseOpt) (*wire.MsgTx, ltcutil.Amount, error) {
...
func TestMaxFeeBailOut(t *testing.T) {
	...
	const (
		absoluteFee = ltcutil.Amount(1000)
		idealFee    = chainfee.SatPerKWeight(253)
	)
...
func TestParseUpfrontShutdownAddress(t *testing.T) {
	...
	var (
		testnetAddress = "tltc1qnv350xe2qddplwtufnt5klru9wws4rlhyq7m0q"
		regtestAddress = "rltc1qqgwyenqr5ygumh9f07hqtpltpmpymmlc6m6lc9"
	)
