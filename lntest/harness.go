...
func (n *NetworkHarness) OpenPendingChannel(ctx context.Context,
	srcNode, destNode *HarnessNode, amt ltcutil.Amount,
...
func (n *NetworkHarness) SendCoins(ctx context.Context, amt ltcutil.Amount,
...
func (n *NetworkHarness) SendCoinsUnconfirmed(ctx context.Context,
	amt ltcutil.Amount, target *HarnessNode) error {
