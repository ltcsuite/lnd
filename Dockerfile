...
ARG checkout="master"
ARG git_url="https://github.com/ltcsuite/lnd"
...
RUN apk add --no-cache --update alpine-sdk \
    ...
    make \
    gcc \
&&  git clone $git_url /go/src/github.com/ltcsuite/lnd \
...
COPY --from=builder /go/src/github.com/ltcsuite/lnd/scripts/verify-install.sh /
COPY --from=builder /go/src/github.com/ltcsuite/lnd/scripts/keys/* /keys/
