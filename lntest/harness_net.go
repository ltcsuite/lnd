...
import (
	...
	"github.com/ltcsuite/lnd/lntest/rpc"
...
func (h *HarnessTest) SetupStandbyNodes() {
	...
	const initialFund = 1 * ltcutil.SatoshiPerBitcoin
...
func (h *HarnessTest) fundCoins(amt ltcutil.Amount, target *node.HarnessNode,
	...
	expectedBalance := ltcutil.Amount(initialBalance.ConfirmedBalance) + amt
...
func (h *HarnessTest) FundCoins(amt ltcutil.Amount, hn *node.HarnessNode) {
...
func (h *HarnessTest) FundCoinsUnconfirmed(amt ltcutil.Amount,
	hn *node.HarnessNode) {
...
func (h *HarnessTest) FundCoinsNP2WKH(amt ltcutil.Amount,
...
func (h *HarnessTest) FundCoinsP2TR(amt ltcutil.Amount,
	target *node.HarnessNode) {
...
func (h *HarnessTest) OpenChannelPsbt(srcNode, destNode *node.HarnessNode,
	...
	fundingAddr, err := ltcutil.DecodeAddress(
	...
	case lnrpc.CommitmentType_SIMPLE_TAPROOT:
		require.IsType(h, &ltcutil.AddressTaproot{}, fundingAddr)

	default:
		require.IsType(
			h, &ltcutil.AddressWitnessScriptHash{}, fundingAddr,
		)
	}
...
func (h *HarnessTest) CreatePayReqs(hn *node.HarnessNode,
	paymentAmt ltcutil.Amount, numInvoices int) ([]string,
	[][]byte, []*lnrpc.Invoice) {
...
func (h *HarnessTest) CalculateTxFee(tx *wire.MsgTx) ltcutil.Amount {
	...
	for _, out := range tx.TxOut {
		balance -= ltcutil.Amount(out.Value)
	}
