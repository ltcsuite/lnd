...
// instance of LtcWallet generated by the New() function.
type Config struct {
	...
	// normally when creating the ltcwallet.
...
func NetworkDir(dataDir string, chainParams *chaincfg.Params) string {
	...
	// and not "testnet4" or any other version, as the chaincfg testnet4
	// parameters will likely be switched to being named "testnet4" in the
	// future.  This is done to future proof that change, and an upgrade
	// plan to move the testnet4 data directory can be worked out later.
