...
func addrPairsToOutputs(addrPairs map[string]int64,
	...
	for addr, amt := range addrPairs {
		addr, err := ltcutil.DecodeAddress(addr, params)
		if err != nil {
			return nil, err
		}
...
func (r *rpcServer) sendCoinsOnChain(paymentMap map[string]int64,
	...
	authoredTx, err := r.server.cc.Wallet.CreateSimpleTx(
		selectedUtxos, outputs, feeRate, minConfs, true,
	)
	if err != nil {
		return nil, err
	}
...
func (r *rpcServer) SendCoins(ctx context.Context,
	...
	rpcsLog.Infof("[sendcoins] addr=%v, amt=%v, sat/kw=%v, min_confs=%v, "+
		...
		in.Addr, ltcutil.Amount(in.Amount), int64(feePerKw), minConfs,
	...
	targetAddr, err := ltcutil.DecodeAddress(
	...
	if in.SendAll {
		...
		var reservedVal ltcutil.Amount
		err = wallet.WithCoinSelectLock(func() error {
			var err error
...
func newFundingShimAssembler(chanPointShim *lnrpc.ChanPointShim, initiator bool,
	...
	return chanfunding.NewCannedAssembler(
		...
		ltcutil.Amount(chanPointShim.Amt), &localKeyDesc,
...
func newPsbtAssembler(req *lnrpc.OpenChannelRequest, normalizedMinConfs int32,
	...
	return chanfunding.NewPsbtAssembler(
		ltcutil.Amount(req.LocalFundingAmount), packet, netParams,
		!psbtShim.NoPublish,
	), nil
}
...
func (r *rpcServer) parseOpenChannelReq(in *lnrpc.OpenChannelRequest,
	...
	remoteChanReserve := ltcutil.Amount(in.RemoteChanReserveSat)
...
func (r *rpcServer) WalletBalance(ctx context.Context,
	...
	var totalBalance, confirmedBalance, unconfirmedBalance ltcutil.Amount
	...
	// chain.
	var lockedBalance ltcutil.Amount
