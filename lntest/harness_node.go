...
func (hn *HarnessNode) WaitForBalance(expectedBalance ltcutil.Amount,
	...
	doesBalanceMatch := func() bool {
		...
		if confirmed {
			...
			return ltcutil.Amount(balance.ConfirmedBalance) ==
				expectedBalance
		}

		lastBalance = ltcutil.Amount(balance.UnconfirmedBalance)
		return ltcutil.Amount(balance.UnconfirmedBalance) ==
			expectedBalance
	}
