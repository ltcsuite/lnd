...
var (
	...
	p2SHAddress = "Qec8RUd8PgAMi6dKDKdHQ7zu71kyQNeU5m"

	// p2wshAddress is a valid pay to witness script hash address.
	p2wshAddress = "ltc1qkzy3u6xcgye9e46hvgmtdkxy4c62u85tzgg7dcwfv7dqcnskjn5qjpgzzp"
)
...
func TestPeerChannelClosureFeeNegotiationsInitiator(t *testing.T) {
	...
	increasedFee := ltcutil.Amount(float64(idealFeeRate) * 2.1)
	...
	increasedFee = ltcutil.Amount(float64(idealFeeRate) * 1.5)
	lastSentFee = increasedFee
