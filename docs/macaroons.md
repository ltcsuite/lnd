...
release](https://github.com/ltcsuite/lnd/releases/tag/v0.3-alpha), we
have addressed [issue 20](https://github.com/ltcsuite/lnd/issues/20),
...
```shell
$  curl --insecure --header "Grpc-Metadata-macaroon: $(xxd -ps -u -c 1000  $HOME/.lndltc/data/chain/litecoin/simnet/admin.macaroon)" https://localhost:8080/v1/getinfo
```
