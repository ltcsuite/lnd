...
func testChainKitSendOutputsAnchorReserve(ht *lntest.HarnessTest) {
	...
	fundingAmount := ltcutil.Amount(100_000)
	...
	chanAmt := fundingAmount - 2*ltcutil.Amount(reserve.RequiredReserve)
...
func testAnchorThirdPartySpend(ht *lntest.HarnessTest) {
	...
	ht.Miner.MineBlockWithTxes([]*ltcutil.Tx{thirdPartyAnchorSweep})
...
func genAnchorSweep(ht *lntest.HarnessTest,
	aliceAnchor *lntest.SweptOutput, anchorCsv uint32) *ltcutil.Tx {
