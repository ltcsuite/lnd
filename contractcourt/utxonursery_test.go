...
var (
	...
	// Dummy timeout tx used to test serialization, borrowed from ltcd
	// msgtx_test
...
func assertNurseryReport(t *testing.T, nursery *UtxoNursery,
	...
	expectedLimboBalance ltcutil.Amount) {
