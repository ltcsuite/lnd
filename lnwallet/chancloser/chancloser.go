...
// compromise fee.
func (c *ChanCloser) proposeCloseSigned(fee ltcutil.Amount) (*lnwire.ClosingSigned, error) {
	var (
		closeOpts []lnwallet.ChanCloseOpt
		err       error
	)
...
// our offered fee.
func ratchetFee(fee ltcutil.Amount, up bool) ltcutil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint, ourIdealFee, lastSentFee,
	remoteFee ltcutil.Amount) ltcutil.Amount {
