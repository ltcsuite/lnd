...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ltcsuite/lnd/lnrpc)
...
5. Run [`gen_protos.sh`](https://github.com/ltcsuite/lnd/blob/master/lnrpc/gen_protos.sh) to generate new protobuf definitions.
