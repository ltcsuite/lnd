...
import (
	...
	mig24 "github.com/ltcsuite/lnd/channeldb/migration24"
	mig25 "github.com/ltcsuite/lnd/channeldb/migration25"
	mig26 "github.com/ltcsuite/lnd/channeldb/migration26"
	mig "github.com/ltcsuite/lnd/channeldb/migration_01_to_11"
...
func deserializeHTLCEntries(r io.Reader) ([]*HTLCEntry, error) {
	...
	for {
		...
		// Patch the Amt field.
		htlc.Amt = ltcutil.Amount(htlc.amtTlv)
