...
func FallbackAddr(fallbackAddr ltcutil.Address) func(*Invoice) {
	return func(i *Invoice) {
...
func parseFallbackAddr(data []byte, net *chaincfg.Params) (ltcutil.Address, error) {
	...
	case 0:
		...
		switch len(witness) {
		case 20:
			addr, err = ltcutil.NewAddressWitnessPubKeyHash(witness, net)
		case 32:
			addr, err = ltcutil.NewAddressWitnessScriptHash(witness, net)
		default:
	...
	case 17:
		...
		addr, err = ltcutil.NewAddressPubKeyHash(pubKeyHash, net)
		if err != nil {
			return nil, err
		}
	case 18:
		...
		addr, err = ltcutil.NewAddressScriptHashFromHash(scriptHash, net)
		if err != nil {
			return nil, err
		}
	default:
