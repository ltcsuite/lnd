...
sources](https://github.com/ltcsuite/lnd/blob/master/lnrpc/lightning.proto).
...
let lndCert = fs.readFileSync("~/.lndltc/tls.cert");
...
let m = fs.readFileSync('~/.lndltc/data/chain/litecoin/simnet/admin.macaroon');
