...
func (w *mockWalletController) ConfirmedBalance(int32, string) (ltcutil.Amount,
	error) {
...
func (w *mockWalletController) IsOurAddress(ltcutil.Address) bool {
	return false
}
...
func (w *mockWalletController) RequiredReserve(uint32) ltcutil.Amount {
	return 0
}
