...
type Neutrino struct {
	...
	UserAgentName      string        `long:"useragentname" description:"Used to help identify ourselves to other litecoin peers"`
	UserAgentVersion   string        `long:"useragentversion" description:"Used to help identify ourselves to other litecoin peers"`
