// Code generated by falafel 0.0.0-cshared6. DO NOT EDIT.
...
func RegisterWalletKitJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["walletrpc.WalletKit.ImportMwebScanKey"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ImportMwebScanKeyRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewWalletKitClient(conn)
		resp, err := client.ImportMwebScanKey(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
