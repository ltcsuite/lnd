...
const (
	...
	// to be used for litecoind backend.
...
type Bitcoind struct {
	...
	RPCPolling           bool          `long:"rpcpolling" description:"Poll the litecoind RPC interface for block and transaction notifications instead of using the ZMQ interface"`
	BlockPollingInterval time.Duration `long:"blockpollinginterval" description:"The interval that will be used to poll litecoind for new blocks. Only used if rpcpolling is true."`
	TxPollingInterval    time.Duration `long:"txpollinginterval" description:"The interval that will be used to poll litecoind for new tx. Only used if rpcpolling is true."`
}
