...
func (m *MempoolNotifier) UnsubsribeConfirmedSpentTx(tx *ltcutil.Tx) {
...
func (m *MempoolNotifier) ProcessRelevantSpendTx(tx *ltcutil.Tx) {
...
// returns them.
func (m *MempoolNotifier) findRelevantInputs(tx *ltcutil.Tx) inputsWithTx {
	txid := tx.Hash()
