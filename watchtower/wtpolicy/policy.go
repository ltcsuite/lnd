...
// policy's fee rate.
func (p *Policy) ComputeAltruistOutput(totalAmt ltcutil.Amount,
	txWeight int64, sweepScript []byte) (ltcutil.Amount, error) {
...
func (p *Policy) ComputeRewardOutputs(totalAmt ltcutil.Amount,
	txWeight int64,
	rewardScript []byte) (ltcutil.Amount, ltcutil.Amount, error) {
...
func ComputeRewardAmount(total ltcutil.Amount, base, rate uint32) ltcutil.Amount {
	rewardBase := ltcutil.Amount(base)
	rewardRate := ltcutil.Amount(rate)
...
func (p *Policy) ComputeJusticeTxOuts(totalAmt ltcutil.Amount, txWeight int64,
