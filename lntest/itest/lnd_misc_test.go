...
func testDisconnectingTargetPeer(net *lntest.NetworkHarness, t *harnessTest) {
	...
	net.SendCoins(t.t, ltcutil.SatoshiPerBitcoin, alice)
...
func testSphinxReplayPersistence(net *lntest.NetworkHarness, t *harnessTest) {
	...
	net.SendCoins(t.t, ltcutil.SatoshiPerBitcoin, carol)
	...
	net.SendCoins(t.t, ltcutil.SatoshiPerBitcoin, fred)
...
func testRejectHTLC(net *lntest.NetworkHarness, t *harnessTest) {
	...
	// Send coins to Alice.
	net.SendCoins(t.t, ltcutil.SatoshiPerBitcent, net.Alice)
...
func testSweepAllCoins(net *lntest.NetworkHarness, t *harnessTest) {
	...
	net.SendCoins(t.t, ltcutil.SatoshiPerBitcoin, ainz)

	net.SendCoinsNP2WKH(t.t, ltcutil.SatoshiPerBitcoin, ainz)
